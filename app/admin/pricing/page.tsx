...
export default function AdminPricingPage() {
  return (
    <div className="min-h-screen bg-[#f4f3ef] text-[#111111] font-sans flex flex-col lg:flex-row selection:bg-[#111111] selection:text-white">
        ...
        <div>
          ...
          <nav className="space-y-1">
            {[
              ...
              { id: 'commercials', label: 'Commercials', icon: '🎬', href: '/admin/commercials' },
              { id: 'requests', label: 'Requests', icon: '📩', href: '/admin/requests' },
              { id: 'pricing', label: 'Pricing Rates', icon: '🏷', href: '/admin/pricing' },
            ].map((tab) => {
              const isActive = tab.id === 'pricing';
              return (
                <Link
                  key={tab.id}
                  href={tab.href}
      ...
      {/* CENTER MAIN: Pricing Manager Component */}
